...
import static store.fooding.backend.common.response.status.BaseExceptionResponseStatus.BAD_SQL_GRAMMAR;
import static store.fooding.backend.common.response.status.BaseExceptionResponseStatus.DATABASE_ERROR;
